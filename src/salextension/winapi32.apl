.head 0 +  Application Description: WINAPI32.APL

- Windows' SDK Functions
- Windows' SDK Constants
- Windows' SDK Structures
- Centura SDK Functions
- Visual Toolchest SDK Functions


Legende:Konstanten-Prefixe
...
.head 2 -  File Include: WindowsSDKStructures.apl
.head 2 -  File Include: CenturaSDKFunctions.apl
.head 2 -  File Include: VTSDKFunctions.apl
.head 2 -  File Include: CommonControlSDKConstants.apl
.head 2 -  File Include: CommonControlSDKFunctions.apl
